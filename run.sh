...
CUDA_VISIBLE_DEVICES=0,1 python scripts/train_cls.py \
    ...
    --decay_points='5,10' \
    --delta=0 \
    --logdir=/kaggle/working/DRS/logs/DRS_learnable \
    --save_folder=/kaggle/working/DRS/checkpoints/DRS_learnable \
    --show_interval=50
...
CUDA_VISIBLE_DEVICES=0,1 python scripts/train_refine.py \
    ...
    --epoch=30 \
    --decay_points='10,20' \
    --logdir=/kaggle/working/DRS/logs/Refine_DRS_learnable \
    --save_folder=/kaggle/working/DRS/checkpoints/Refine_DRS_learnable \
    --show_interval=50
